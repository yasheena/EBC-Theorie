"""
EBC Figure 1 — Publication-ready version for v3.
Used for: EBC Paper v3 (in Vorbereitung)
Basis: EBC_v2_figures_source.py
Änderungen gegenüber v2:
  - Bildunterschriften: f≈5–13% → f≈4–7% (korrigierte numerische Integration)
  - Ausgabedateien: EBC_v3_fig1a.svg / EBC_v3_fig1b.svg
...
ax.text(0.015, 0.045,
        ...
        'Cycle position $f\\approx4$–$7\\%$ with matter (Section 3.2). '
...
fig.tight_layout()
fig.savefig(os.path.join(OUTPUT_DIR, 'EBC_v3_fig1a.svg'), format='svg', bbox_inches='tight', facecolor='white')
fig.savefig(os.path.join(OUTPUT_DIR, 'EBC_v3_fig1a_preview.png'), dpi=200, bbox_inches='tight', facecolor='white')
plt.close(fig)
...
ax2.text(0.015, 0.04,
         ...
         r'With $\Omega_m\approx0.31$: cycle position $f\approx4$–$7\%$ (Section 3.2). '
...
fig2.tight_layout()
fig2.savefig(os.path.join(OUTPUT_DIR, 'EBC_v3_fig1b.svg'), format='svg', bbox_inches='tight', facecolor='white')
fig2.savefig(os.path.join(OUTPUT_DIR, 'EBC_v3_fig1b_preview.png'), dpi=200, bbox_inches='tight', facecolor='white')
plt.close(fig2)
print('Fig 1b saved (SVG + PNG preview).')
print('\nAll figures complete.')
print(f'Output directory: {OUTPUT_DIR}')
print('Next step: open SVGs in Inkscape, correct layout,')
print('           save as EBC_v3_fig1a_final.svg / EBC_v3_fig1b_final.svg,')
print('           and export as EBC_v3_fig1a_final.pdf / EBC_v3_fig1b_final.pdf.')
