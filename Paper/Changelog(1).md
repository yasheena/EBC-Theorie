...
### Grafiken
- **Grafik-Quellcode:** `Figures/EBC_v3_figures_source.py`
  - Bildunterschriften auf f ≈ 4–7% aktualisiert.
  - Ausgabe: `EBC_v3_fig1a.svg` / `EBC_v3_fig1b.svg` (→ Inkscape-Bearbeitung erforderlich).
- Finalisierte Grafiken (nach Inkscape-Bearbeitung): `EBC_v3_fig1a_final.svg/pdf`, `EBC_v3_fig1b_final.svg/pdf`
...
### Grafiken
- **Grafik-Quellcode:** `Figures/EBC_v2_figures_source.py` (eingefroren)
  - Bildunterschriften: f ≈ 5–13% (Stand der Veröffentlichung).
  - Ausgabe: `EBC_v2_fig1a.svg` / `EBC_v2_fig1b.svg`
- Finalisierte Grafiken (Inkscape-bearbeitet): `EBC_v2_fig1a_final.svg/pdf`, `EBC_v2_fig1b_final.svg/pdf`
